...
#データの読み込み
train_df = pd.read_csv('/root/Kaggle/HousePrices_kaggls/train1.csv',index_col=0)
test_df = pd.read_csv('/root/Kaggle/HousePrices_kaggls/test1.csv')
...
submission_df = pd.read_csv('/root/Kaggle/HousePrices_kaggls/sample_submission.csv')
